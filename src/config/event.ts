...
export const eventConfig: EventConfig = {
  ...
  about: {
    ...
    description2: "A transcendent convergence from 9:00 AM to 9:00 PM.",
    stats: [
  ...
  ticketTypes: [
    ...
    },
    {
      ...
      priceUSD: 25,
      priceETB: 1000,
      description: "VIP sites, express fast-track gates, plus 2 FREE BEERS included with ticket!",
  ...
  socialLinks: [
    ...
    { name: "TELEGRAM", url: "https://t.me/Enqu_events", icon: "Send" },
  ],
};
