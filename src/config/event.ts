  ...
  artists: [
    {
      id: "dj-natu",
      name: "DJ NATU",
      role: "ETHIO-ELECTRONIC & AFRO-HOUSE DJ",
  ...
  schedule: [
    {
      ...
      items: [
        ...
        },
        {
          ...
          stage: "GRAND CINEMATIC ARENA",
          category: "music",
          description: "Hypnotic Ethio-electronic & Afro-house DJ sets by DJ Natu with MC Santa.",
        },
        {
        ...
        },
        {
          ...
          artist: "DJ NATU & MC SANTA",
          stage: "SKY GARDEN DOME",
          category: "vip",
          description: "Monumental closing set featuring DJ Natu & MC Santa ending promptly at 9:00 PM / 3:00 Night Local.",
        },
      ],
    },
  ],
  ...
  ticketTypes: [
    {
      ...
      priceUSD: 10,
      priceETB: 400,
      description: "Full day access to 3 main stages, art pavilions, gaming lounges, and artisan food gardens (9 AM – 9 PM).",
